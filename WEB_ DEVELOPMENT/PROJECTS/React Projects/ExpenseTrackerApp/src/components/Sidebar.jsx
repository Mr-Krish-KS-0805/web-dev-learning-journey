    ...
    return (
        <div className='h-screen flex flex-col overflow-y-auto w-55 bg-[#1e2938] border-r border-gray-500 py-2'>
            ...
            <div className='text-[#e2e8f0] pt-2 pl-5  flex flex-col gap-5 '>
                ...
                <NavLink to='/report' className={({isActive}) => `flex items-center gap-3 transition-all duration-300 ${isActive ? "bg-red-900 text-white pl-5 py-2 font-bold rounded-l-full " : "text-gray-400"}`}><FiTrendingUp className='text-2xl' />Reports 😱</NavLink>
                <NavLink to='/budget' className={({isActive}) => `flex items-center gap-3 transition-all duration-300 ${isActive ? "bg-red-900 text-white pl-5 py-2 font-bold rounded-l-full " : "text-gray-400"}`}><HiOutlineWallet className='text-2xl' />Budget 😱</NavLink>
                <NavLink to='/recurring' className={({isActive}) => `flex items-center gap-3 transition-all duration-300 ${isActive ? "bg-red-900 text-white pl-5 py-2 font-bold rounded-l-full " : "text-gray-400"}`}><FiRepeat className='text-2xl' />Recurring 😱</NavLink>
