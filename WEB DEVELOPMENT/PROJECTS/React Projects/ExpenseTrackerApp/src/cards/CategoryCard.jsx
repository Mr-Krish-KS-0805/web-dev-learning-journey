...
const CategoryCard = () => {
  return (
    <div className='bg-[#1e2938] h-full flex flex-col gap-3 px-5 justify-center  border-2 border-gray-700 rounded-xl'>
      ...
      <div className='flex relative items-center'>
        ...
        <div className='pl-3'>
          <h1 className='text-lg text-gray-400'>Food & Dining</h1>
          <p className='text-xl text-white'>₹5,800</p>
        </div>
